...
mappe til projektet i din ’www’ mappe, kald den f.eks. “projektnavn_ditnavn”. Et mappenavn i stil med “theband_jesper” er et godt bud, hvis det altså er “The Band” opgaven og det er
Jesper der arbejder med den. 

Inde i den mappe opretter du to nye mapper, en du navngiver
images og en du navngiver stylesheets. Image mappen
er den mappe som skal indeholde de billeder som skal bruges i sitet. stylesheets er den mappe som skal indeholde dit stylesheet.
...
navnet ‘Image’ er således ikke en samme mappe som mappen med navnet ‘image’. 

Når man skriver kode, er det lettest at filer og mapper har en ensartet navngivning. Så er det lettest
